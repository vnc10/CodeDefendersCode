...
CREATE TABLE `games` (
  ...
  `Attacker_Cost_Activity` int(11) DEFAULT '1',
  `Defender_Cost_Activity` int(11) DEFAULT '1',
  `Attacker_Start_Cost_Activity` int(11) DEFAULT '10',  
  `Defender_Start_Cost_Activity` int(11) DEFAULT '10',  
